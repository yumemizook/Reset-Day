local defaultGameplayCoordinates = {
	...
	DisplayPercentY = 55,
	DisplayMeanX = 10,
	DisplayMeanY = SCREEN_BOTTOM - 100,
	NPSDisplayX = SCREEN_WIDTH - 120,
	NPSDisplayY = 100,
	NPSGraphX = SCREEN_WIDTH - 200,
	NPSGraphY = 120,
	NotefieldX = 0,
	NotefieldY = 0,
	ProgressBarPos = 1,
	LeaderboardX = SCREEN_WIDTH - 220,
	LeaderboardY = 250,
	...
	PracticeCDGraphY = 85,
	BPMTextX = 10,
	BPMTextY = SCREEN_BOTTOM - 50,
	MusicRateX = 10,
	MusicRateY = SCREEN_BOTTOM - 30
}
